# Ecommerce-_sale_-report
Power BI dashboard for analyzing e-commerce sales performance by category, region, and courier status. Includes key KPIs, sales trends, and interactive filters for deeper business insights
E-Commerce Sales Dashboard: Turning Data into Business Insights
Problem Statement
...
Compare sales across channels like Amazon and Non-Amazon.

Monitor category-wise sales growth and monthly trends.

Analyze courier performance and delivery efficiency.

In short, the dashboard helps business teams make data-driven decisions that improve sales strategy, product management, and logistics.
